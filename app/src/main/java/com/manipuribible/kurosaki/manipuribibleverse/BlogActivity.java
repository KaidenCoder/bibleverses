...
//
//public class BlogActivity extends AppCompatActivity implements BlogListFragment
...
//        setContentView(R.layout.old_activity_blog);
//
...
//                BlogListFragment moviesListFragment = getMoviesFragment(getResources()
//                        .getConfiguration());
...
//            if (currentFragment instanceof BlogListFragment && !isInternetConnected()) {
//                NoInternetFragment noInternetFragment = NoInternetFragment.newInstance();
...
//    private BlogListFragment getMoviesFragment(Configuration config) {
//        if (config.orientation == Configuration.ORIENTATION_PORTRAIT) {
//            return BlogListFragment.newInstance(Constants.PORTRAIT_COLUMN_COUNT);
//        } else {
//            return BlogListFragment.newInstance(Constants.LANDSCAPE_COLUMN_COUNT);
//        }
//    }
//
//    @Override
//    public void onMoviesListInteraction(Blog movieItem) {
//        Intent intent = new Intent(this, DetailsActivity.class).putExtra(Constants.EXTRA_BLOG,
//                movieItem);
